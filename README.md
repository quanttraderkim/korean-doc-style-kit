...
> 이 레포의 `skills/korean-doc-skill/SKILL.md`를 기준으로 이 문서를 전략 문서로 다시 써줘. 원문 논리는 유지하고, 첫 화면에 핵심 판단과 요청사항이 보이게 해줘.
...
- 정본 역할의 스킬 문서: [`skills/korean-doc-skill/SKILL.md`](./skills/korean-doc-skill/SKILL.md)
