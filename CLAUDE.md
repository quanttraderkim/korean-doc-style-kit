...
정본은 [`skills/report-memo-doc-style/SKILL.md`](./skills/report-memo-doc-style/SKILL.md)입니다. Claude Code는 공식적으로 `~/.claude/skills/<skill-name>/SKILL.md` 또는 프로젝트 `.claude/skills/<skill-name>/SKILL.md` 위치의 스킬을 지원하므로, 가능하면 이 경로에 설치해서 실제 skill처럼 쓰는 방식을 권장합니다.
